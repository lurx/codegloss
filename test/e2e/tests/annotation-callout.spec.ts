...
test.describe('annotation callout', () => {
  ...
  test('clicking a mark opens a callout with the right content', async ({ page }) => {
  ...
  test('clicking the same mark a second time dismisses the callout', async ({ page }) => {
    const wc = page.locator('code-gloss');
  ...
  test('clicking a different mark switches the active callout', async ({ page }) => {
    const wc = page.locator('code-gloss');
  ...
  test('clicking elsewhere in the pre does not open a callout', async ({ page }) => {
    const wc = page.locator('code-gloss');

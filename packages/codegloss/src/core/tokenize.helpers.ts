...
const SYNTAX_RULES = [
	...
	{
		pattern:
			/\b(function|const|let|var|if|return|throw|new|while|for|else|class|import|export|from|default|typeof|instanceof|void|null|undefined|true|false)\b/,
		className: 'keyword',
	},
...
export function findAnnotationHits(
	...
	const lineAnnotations = annotations.filter(ann => ann.line === lineIdx);

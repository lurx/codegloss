...
Now use the fenced sandbox syntax in any `.md` or `.svx` file:
...
You can mix both styles on the same page. Fenced sandbox blocks are ideal for documentation-heavy pages, while the direct wrapper is useful when you need dynamic props or programmatic control.

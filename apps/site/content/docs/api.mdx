...
When a connection has `text`, the arc and its endpoint dots become clickable. Clicking opens a popover (using the native [Popover API](https://developer.chrome.com/blog/introducing-popover-api)) with the title and text — useful for explaining _why_ two pieces of code are related.
